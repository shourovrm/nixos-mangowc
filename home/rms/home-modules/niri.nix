...

{
  ...
  xdg.configFile."niri/config.kdl".text = ''
    ...
    // ── Raffi launcher — open as a centered floating overlay ─────────────
    window-rule {
      match app-id="raffi"
      open-floating true
    }
    ...
    binds {
      ...
      // Launchers
      Mod+D       { spawn "fuzzel"; }  // default desktop app launcher (Super+D)
      Mod+Ctrl+D  { spawn "raffi" "--ui-type" "native"; }  // raffi tools launcher
